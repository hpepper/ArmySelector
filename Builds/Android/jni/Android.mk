...
ifeq ($(CONFIG),Debug)
  ...
  LOCAL_CPPFLAGS += -fsigned-char -fexceptions -frtti -I "../../JuceLibraryCode" -I "../../JuceLibraryCode/modules" -Os -D "JUCE_ANDROID=1" -D "JUCE_ANDROID_API_VERSION=8" -D "JUCE_ANDROID_ACTIVITY_CLASSNAME=com_yourcompany_armyselector_ArmySelector" -D JUCE_ANDROID_ACTIVITY_CLASSPATH=\"com/yourcompany/armyselector/ArmySelector\" -D "NDEBUG=1" -D "JUCER_ANDROID_7F0E4A25=1" -D "JUCE_APP_VERSION=0.1.0" -D "JUCE_APP_VERSION_HEX=0x100"
  LOCAL_LDLIBS := -llog -lGLESv2
